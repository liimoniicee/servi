  ...
  <header id="page-header" class="clearfix">
  	...
  	<div class="row-fluid">
  			...
  			<div class="header-text">
  				<a class="logo" href="#" title="Página Principal (home)">
  					<img src="imag/img-log-complet.png" class="img-responsive" alt="logo">				</a>
  			</div>
  		</div>
  ...
  <div class="row">
                      	<div class="container col-md-8">
                          	<div class="header-text text-center">
                              	<h2>Servicio social ITES Los Cabos</h2>
                              	<h4>REGISTRO</h4>

                          	</div>
                      	</div>
                          <div class="container col-md-8" style="background-color:aliceblue; padding: 50px;">
    ...
    <h3 class="text-center">Escolaridad</h3>
    <hr>
    <div class="form-group">
